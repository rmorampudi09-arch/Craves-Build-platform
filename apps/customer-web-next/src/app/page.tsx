    ...
    <main className="mx-auto min-h-screen max-w-6xl px-5 py-12 sm:px-8">
      <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
        <section>
          ...
          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300">Discover nearby home food, build your cart, manage delivery addresses, review orders, follow delivery progress or enter chef mode through the secure Next.js experience.</p>
