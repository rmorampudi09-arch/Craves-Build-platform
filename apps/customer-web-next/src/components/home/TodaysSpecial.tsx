...
export function TodaysSpecial({ dishes }: { dishes: Dish[] }) {
  ...
  return (
    <section className={`${styles.fadeUp} ${styles.delayTwo} mx-auto max-w-[88rem] px-4 pt-12 md:px-7 lg:px-10 lg:pt-16`}>
      <div className="rounded-[2.25rem] border border-[#E8D5C8] bg-[#F7EBDD] px-5 py-7 shadow-[0_16px_50px_rgba(67,44,34,0.07)] sm:px-7 md:px-9 md:py-9">
        <div className="mb-7 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1.5 font-display text-3xl font-black tracking-[-0.045em] text-[#261A15] md:text-4xl">
              Today’s Special
            </h2>
            <p className="mt-2 max-w-xl text-sm leading-6 text-[#795F54]">
              A quick look at fresh dishes currently available from home kitchens near you.
            </p>
          </div>
          <span className="hidden rotate-[-2deg] rounded-full border border-[#DABFAF] bg-[#FFF9F2] px-4 py-2 text-xs font-black text-[#70564A] md:block">
