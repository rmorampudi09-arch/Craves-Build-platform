...
/** "Are you a passionate cook?" — banner encouraging chef sign-ups. */
        ...
        <div className="grid items-center gap-6 p-8 md:grid-cols-[1fr_auto_1fr] md:p-12">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="mt-2 text-white/90">Join Craves and turn your passion into pride.</p>
              <button className="mt-4 inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-primary transition-transform hover:-translate-y-0.5">
          ...
          <div className="flex items-center gap-6">
            <div>
              <h3 className="text-2xl font-bold text-white md:text-3xl">Earn. Share. Inspire.</h3>
              <p className="mt-2 text-white/90">Be your own boss and delight more hungry hearts!</p>
            </div>
            <img
              src={assetUrl(chefsCta)}
              alt=""
