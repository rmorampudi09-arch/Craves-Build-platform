  ...
  return (
    <View accessibilityRole="tablist" style={styles.tabStrip}>
      {CHEF_ORDER_TABS.map(tab => {
        ...
        const enabled = tab === 'NEW' || tab === 'PREPARING';
        return (
          <Pressable
            accessibilityHint={
              enabled
...
const styles = StyleSheet.create({
  ...
  summaryBanner: {flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginHorizontal: spacing.md, marginBottom: spacing.sm, padding: spacing.md, borderRadius: radius.lg, backgroundColor: colors.surfaceWarm},
