...
const styles = StyleSheet.create({
  ...
  quantityBadge: {alignItems: 'center', backgroundColor: colors.surfaceWarm, borderRadius: radius.sm, justifyContent: 'center', minHeight: 38, minWidth: 38},
  ...
  locationIcon: {alignItems: 'center', backgroundColor: colors.surfaceWarm, borderRadius: radius.pill, height: 40, justifyContent: 'center', width: 40},
