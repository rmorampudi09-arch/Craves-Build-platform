...
jq -n '{properties:{displayName:"List my chef earnings",method:"GET",urlTemplate:"/",templateParameters:[],responses:[{statusCode:200,description:"Chef-owned earning ledger entries"},{statusCode:400,description:"Invalid limit"},{statusCode:401,description:"Authentication required"},{statusCode:403,description:"Chef role required"}]}}' >"$BODY"
