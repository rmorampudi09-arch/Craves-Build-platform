...
remove_route "api/v1/subscription-payments" POST "/invoices/{invoiceId}/verify"
remove_route "api/v1/payments" POST "/webhooks/cashfree"

echo "SUCCESS: Subscription payment provider/Cashfree webhook APIM operations removed. API containers were retained."
