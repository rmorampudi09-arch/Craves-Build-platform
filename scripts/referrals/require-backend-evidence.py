...
required = {
 'referral-service': {'ReferralLedgerIT':1,'ReferralResilienceIT':1,'ReferralHttpContractIT':1,'ReferralFinanceTransportIT':3,'ReferralCheckoutBenefitsIT':8,'ReferralAuthStateClientTest':9},
