...
da15af75a4574034bf7ef8692ba52b16a4a23edeef70021f914242e42966614e  services/integration-service/src/main/resources/db/migration/V116__delivery_intelligence_admin_read_indexes.sql
CHECKSUMS
...
test -f services/integration-service/src/main/resources/db/migration/V116__delivery_intelligence_admin_read_indexes.sql.conf
grep -Fxq 'executeInTransaction=false' services/integration-service/src/main/resources/db/migration/V116__delivery_intelligence_admin_read_indexes.sql.conf
