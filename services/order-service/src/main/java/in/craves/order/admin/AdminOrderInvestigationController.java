...
public class AdminOrderInvestigationController {
    ...
    public ResponseEntity<OrderInvestigationResponse> investigate(
        ...
        OrderSnapshot order = jdbcTemplate.query(
            ...
            (rs, rowNum) -> new OrderSnapshot(
                ...
                rs.getObject("subscription_occurrence_id", UUID.class),
                rs.getObject("subscription_id", UUID.class),
                rs.getObject("scheduled_service_at", OffsetDateTime.class),
                rs.getString("financial_allocation_status"),
                rs.getObject("delivery_address_id", UUID.class),
                rs.getString("dropoff_recipient_name"),
                maskPhone(rs.getString("dropoff_contact_phone")),
    ...
    public record OrderSnapshot(
        ...
        String orderSource,
        UUID subscriptionOccurrenceId,
        UUID subscriptionId,
        OffsetDateTime scheduledServiceAt,
        String financialAllocationStatus,
        ...
        OffsetDateTime deliveryStatusObservedAt,
        UUID refundId,
        String refundReference,
        String refundProviderStatus,
        String cashfreeRefundId,
        OffsetDateTime refundStatusUpdatedAt,
