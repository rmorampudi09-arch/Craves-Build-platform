...
public class ChefDeliveryStatusController {
    private final DeliveryStatusQueryService queryService;

    public ChefDeliveryStatusController(DeliveryStatusQueryService queryService) {
    ...
    public DeliveryStatusResponse getDeliveryStatus(
        ...
        return queryService.getForChef(principal, orderId);
    }
}
