...
public final class SourceAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Override protected void doFilterInternal(HttpServletRequest request,HttpServletResponse response,FilterChain chain) throws IOException,ServletException {
        try {
            ...
            require(List.of("/internal/v1/referrals/events","/internal/v1/referrals/operations","/internal/v1/referrals/outbox/claim","/internal/v1/referrals/outbox/ack").contains(path),404,"SOURCE_ROUTE_NOT_FOUND");
