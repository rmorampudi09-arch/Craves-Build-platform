...
import in.craves.userchef.observability.RequestCorrelationFilter;
...
public class AppErrorHandler {
    ...
    public ResponseEntity<ErrorBody> onInvalid(MethodArgumentNotValidException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorBody> onResponseStatus(ResponseStatusException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorBody> onUnexpected(Exception ex, HttpServletRequest request) {
        String correlationId = RequestCorrelationFilter.current(request);
        log.error("Unhandled user-chef service error correlationId={}", correlationId, ex);
    ...
    private static ErrorBody error(
        int status,
        String code,
        String message,
        List<String> details,
