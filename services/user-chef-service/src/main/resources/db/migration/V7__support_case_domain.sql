...
COMMENT ON TABLE support_case IS
    'Identity-owned customer/chef support workflow. Durable requester notifications are enqueued by SupportCaseService into the existing notification_outbox in the same transaction.';
